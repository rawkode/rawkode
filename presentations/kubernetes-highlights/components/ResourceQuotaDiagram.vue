<template>
  <div class="resource-wrapper">
    <svg viewBox="0 0 900 480" class="diagram" role="img" aria-label="Resource Quota Allocation">
      ...
      <!-- QoS Indicators -->
      <g v-click class="fade-in">
        <rect x="70" y="380" width="140" height="8" class="qos-guaranteed" />
        <text x="145" y="355" class="qos-label" text-anchor="middle">Guaranteed</text>

        <rect x="260" y="380" width="140" height="8" class="qos-burstable" />
        <text x="330" y="355" class="qos-label" text-anchor="middle">Burstable</text>

        <rect x="450" y="380" width="140" height="8" class="qos-burstable" />
        <text x="520" y="355" class="qos-label" text-anchor="middle">Burstable</text>

        <rect x="640" y="380" width="140" height="8" class="qos-burstable" />
        <text x="710" y="355" class="qos-label" text-anchor="middle">Burstable</text>
      </g>
      ...
      <!-- Legend -->
      <g v-click class="fade-in">
        <rect x="40" y="460" width="500" height="15" rx="4" class="legend" />
        <rect x="54" y="465" width="10" height="10" rx="2" class="legend-used" />
        <text x="72" y="474" class="legend-text">Used</text>

        <rect x="124" y="465" width="10" height="10" rx="2" class="legend-remaining" />
        <text x="142" y="474" class="legend-text">Remaining</text>

        <rect x="234" y="465" width="10" height="10" rx="2" class="legend-guaranteed" />
        <text x="252" y="474" class="legend-text">Guaranteed QoS</text>

        <rect x="374" y="465" width="10" height="10" rx="2" class="legend-burstable" />
        <text x="392" y="474" class="legend-text">Burstable QoS</text>
      </g>
    </svg>
...
/* Namespace */
.namespace-box { fill: color-mix(in oklab, var(--rk-black) 6%, transparent); stroke: var(--rk-primary); stroke-width: 1.5; }
.namespace-label { font: 600 14px/1.2 'Poppins', sans-serif; fill: #fff; }

/* ResourceQuota Object */
.quota-obj { fill: color-mix(in oklab, var(--rk-secondary) 20%, transparent); stroke: var(--rk-secondary); stroke-width: 1.2; }
.quota-title { font: 600 12px/1.2 'Poppins', sans-serif; fill: #fff; }
.quota-sub { font: 400 10px/1.2 'Quicksand', sans-serif; fill: #fff; opacity: 0.8; }

/* Section titles */
.section-title { font: 600 13px/1.2 'Poppins', sans-serif; fill: var(--rk-secondary); }

/* Resource bars */
.bar-bg { fill: color-mix(in oklab, var(--rk-black) 10%, transparent); stroke: #fff3; }
.bar-used { fill: url(#resourceGrad); }
.bar-used.cpu { fill: color-mix(in oklab, #8B5CF6 40%, transparent); stroke: #8B5CF6; }
.bar-used.memory { fill: color-mix(in oklab, #EC4899 50%, transparent); stroke: #EC4899; }
.bar-used.pods { fill: color-mix(in oklab, #10B981 40%, transparent); stroke: #10B981; }

.bar-label { font: 400 11px/1 'Quicksand', sans-serif; fill: #fff; opacity: 0.7; }
.bar-value { font: 600 11px/1 'Poppins', sans-serif; fill: #fff; }

/* Pod rows */
.pod-row { fill: color-mix(in oklab, var(--rk-black) 8%, transparent); stroke: #fff4; stroke-width: 1; }
.pod-name { font: 500 10px/1 'Quicksand', sans-serif; fill: #fff; }
.pod-usage { font: 400 10px/1 'Quicksand', sans-serif; fill: #fff; opacity: 0.8; }

/* QoS indicators */
.qos-guaranteed { fill: #10B981; }
.qos-burstable { fill: #F59E0B; }
.qos-label { font: 500 10px/1 'Quicksand', sans-serif; fill: #fff; opacity: 0.9; }

/* Warning */
.warning-box { fill: color-mix(in oklab, #EF4444 20%, transparent); stroke: #EF4444; stroke-width: 1.2; }
.warning-title { font: 600 12px/1.2 'Poppins', sans-serif; fill: #EF4444; }
.warning-text { font: 400 10px/1.2 'Quicksand', sans-serif; fill: #fff; }

/* Legend */
.legend { fill: color-mix(in oklab, var(--rk-black) 6%, transparent); stroke: #fff2; }
.legend-used { fill: url(#resourceGrad); }
.legend-remaining { fill: color-mix(in oklab, var(--rk-black) 10%, transparent); stroke: #fff3; }
.legend-guaranteed { fill: #10B981; }
.legend-burstable { fill: #F59E0B; }
