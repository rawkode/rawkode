...
function checkpoint(before: DrawingDocument) {
...
function point(event: PointerEvent): DrawingPoint {
...
function hit(element: DrawingElement, point: DrawingPoint): boolean {
...
function setInk(value: DrawingInk) {
	ink.value = value;
