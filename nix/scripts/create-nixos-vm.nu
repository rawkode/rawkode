...
def main [] {
	...
	print "     curl -fsSL https://raw.githubusercontent.com/rawkode/nix/main/scripts/install-nixos-vm.nu -o /tmp/install-nixos-vm.nu"
	print "     sudo nu /tmp/install-nixos-vm.nu"
	print ""
	print "  3. After install completes, eject ISO and reboot"
	print ""
	print "  4. Future rebuilds:"
	print "     cd /tmp/nix && git pull"
	print "     sudo nixos-rebuild switch --flake /tmp/nix#p4x-parallels-nixos"
}
