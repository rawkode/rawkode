...
def main [] {
	...
	print ""
	print "  2. In the VM console, run the installer (the minimal ISO has no nushell, so fetch it via nix-shell):"
	print "     sudo -i"
	...
	print "     nix-shell -p nushell --run 'nu /tmp/install-nixos-vm.nu'"
	print ""
