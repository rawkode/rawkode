...
${builtins.readFile ./config.kdl}
    ...
    # Clipcat configuration
    xdg.configFile."clipcat/clipcatd.toml".text = ''
daemonize = true
pid_file = "/run/user/${toString config.home.uid}/clipcatd.pid"
...
host = "127.0.0.1"
port = 45045
local_socket = "/run/user/${toString config.home.uid}/clipcat/grpc.sock"
...
server_endpoint = "/run/user/${toString config.home.uid}/clipcat/grpc.sock"
...
[finder_options]
rofi_finder = { prompt = "Clipcat", extra_arguments = ["-dmenu", "-i"] }
