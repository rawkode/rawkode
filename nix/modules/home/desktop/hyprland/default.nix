    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        general = {
          ...
          layout = if scroller then "scroller" else "";
          gaps_in = 16;
          gaps_out = 16;
          border_size = 2;
        };

        plugin = mkIf scroller {
          scroller = {
        ...
        bind =
          [
            ...
            "$mainMod, Space, exec, ${lib.getExe pkgs.fuzzel}"
          ...
          ++ optionals scroller [
            # Hyprscroller Keys
            "$mainMod, F, scroller:cyclesize, 1"
