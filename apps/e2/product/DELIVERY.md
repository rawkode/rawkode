...
- Native editor remains opt-in preview. Fixed actor-isolation compilation, unsafe
  list joins/outdents, day/account save races, cancelled acknowledgements, and
  lost drafts on close or offline reopen. Native drafts persist atomically before
  network sync; conflicts retain local edits. Failed disk writes prevent closing.
...
- Verified 86 core tests, iOS Simulator and Mac builds, and five native editor
  journeys: immediate close/relaunch, exact heading/paragraph/relaunch, checklist,
  canonical mention, and drawing with Dawn/Dark screenshots. See
