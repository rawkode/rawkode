    ...
    var body: some View {
        Group {
            if store.captures.isEmpty {
                ContentUnavailableView { Label("No captures", systemImage: "tray") } description: { Text("Save a thought to return to later.") } actions: { Button("New capture") { store.capturePresented = true }.buttonStyle(.glassProminent) }
            } else {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        HStack(spacing: 20) {
                            ...
                            Menu {
                                ...
                                Button("Add to device notes", systemImage: "internaldrive") { store.addToToday(capture) }
        ...
        .toolbar { ToolbarItem { Button { store.capturePresented = true } label: { Label("New capture", systemImage: "square.and.pencil") }.accessibilityIdentifier("newCapture") } }
