...
export const MUTATION_INGRESS_REGISTRY: readonly MutationIngressEntry[] = [
  ...
  { id: "do-alarm:none", adapter: "do-alarm", symbol: "WorkspaceDurableObject.alarm", disposition: "non-semantic", owner: "platform", stateEffect: "non-semantic", actorContext: "none", rationale: "not-applicable", replay: "none", recipient: "none" },
