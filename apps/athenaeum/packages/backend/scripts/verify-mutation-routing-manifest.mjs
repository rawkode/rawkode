...
const readOnlyRpcMethods = new Set([
  ...
  "listPendingChanges", "getChatReview", "listApps", "getApp", "getAppCode", "previewRemoveCollaborator", "previewRevokeShareLink",
...
const ledgerRoutes = ["createNode", "createNodeWithIntent", "createLoroPage", "acceptChatFork", "acceptPageProposal", "addFact", "createRelationDefinition", "createEdge", "createTag", "updateTag", "syncNoteReferences", "assignTag", "unassignTag", "defineTagField", "applySupertag", "mergeChanges", "revertChanges", "decideAgentChangeProposal", "decideChatReview", "createApp", "updateAppCode", "deleteApp", "migrateLegacyPage", "commitLoroPageContent", "prepareMeetingInDailyNote", "linkCalendarEventToNode", "createBookmark", "appendTranscriptSegment", "startMeeting"]
