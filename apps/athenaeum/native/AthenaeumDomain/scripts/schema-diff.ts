...
const MIRRORED_CLASSES: ReadonlyArray<{ tsExportName: string; swiftStructName: string }> = [
  ...
  { tsExportName: "GetChatReviewInput", swiftStructName: "GetChatReviewInput" },
  { tsExportName: "ChatReviewItem", swiftStructName: "ChatReviewItem" },
  { tsExportName: "ChatReviewForkLaneStatus", swiftStructName: "ChatReviewForkLaneStatus" },
  { tsExportName: "GetChatReviewOutput", swiftStructName: "GetChatReviewOutput" },
  { tsExportName: "DecideChatReviewInput", swiftStructName: "DecideChatReviewInput" },
  { tsExportName: "DecideChatReviewOutput", swiftStructName: "DecideChatReviewOutput" },
