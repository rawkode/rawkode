...
public enum LoroMutationWire {
    public static let humanSurfaces: Set<String> = ["rich-text-editor", "ios-rich-text-editor", "web-supertag-field-editor", "web-supertags-manager", "web-graph-view", "web-backlinks", "web-bookmarks", "ios-supertags", "macos", "watch-quick-capture"]
