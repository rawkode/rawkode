...
export function buildMiniAppGenerationPrompt(input: {
	...
	const sections = [
		...
		"- Only call global fetch for the declared /api/host/resource-index/search host API. Do not mutate URL host, hostname, href, origin, port, or protocol before fetching.",
