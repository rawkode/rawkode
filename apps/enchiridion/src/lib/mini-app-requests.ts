...
export function buildMiniAppGenerationPrompt(input: {
	...
	const sections = [
		...
		"- Do not include script tags, inline event handlers, javascript: URLs, or forms. Dynamic mini app pages are served with a CSP sandbox; use server-rendered HTML and links, or require host-native promotion for trusted interactivity.",
