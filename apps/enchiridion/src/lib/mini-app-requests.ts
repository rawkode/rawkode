...
export function buildMiniAppGenerationPrompt(input: {
	...
	const sections = [
		...
		"- If the app declares a scheduled workflow, set workflowName to \"run-mini-app-workflow\", declare cron, and add a worker-fragment route at /apps/<slug>/_workflows/<workflow-id>.",
