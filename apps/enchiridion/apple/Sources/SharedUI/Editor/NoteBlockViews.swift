...
struct NoteTextSegmentView: View {
    ...
    init(model: NoteEditorModel, block: NoteBlock, segmentIndex: Int, segmentText: AttributedString, range: Range<Int>,
         alignment: TextAlignment, focus: FocusState<NoteFocus?>.Binding, theme: EnchiridionTheme, placeholder: String?) {
...
struct NoteCodeBlockView: View {
    ...
    init(model: NoteEditorModel, block: NoteBlock, focus: FocusState<NoteFocus?>.Binding, theme: EnchiridionTheme) {
