...
kubectl --kubeconfig /etc/kubernetes/admin.conf -n ambassador patch svc ambassador -p "{\"spec\": {\"type\": \"LoadBalancer\", \"externalTrafficPolicy\": \"Local\", \"loadBalancerIP\": \"${INGRESS_IP}\"}}"
