// Enchiridion2MacApp.swift
// Enchiridion2Mac
//
// P1 "iOS app" task's macOS half — plan §Phasing P1: "full editor (Text +
// marks + page references), ... iOS app." This is the minimal app shell the
// plan calls for at this stage: no navigation/list UI yet (that lands once
